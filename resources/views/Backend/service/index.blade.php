        ...
        <div class="card">
            <div class="card-body">
                <div class="text-end mb-3">
                    <a href="{{ route('service.create') }}" class="btn btn-md btn-info "><i class="ft-plus"></i>Create
                        New</a>
                </div>
                <table id="serviceTable" class="table dt-responsive nowrap w-100"></table>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
        ...
        function deleteService(x) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#serviceTable').DataTable().clear().draw();
                },
            });
        }
</script>
