...
@section('main.content')
    <section id="hero" class="hero d-flex align-items-center">
        ...
        <img data-aos="fade-up" src="{{ asset('public/frontend/assets/img/Ellipse 4.png') }}" alt=""
            class="circleCenter" style="top:2%">
        <img data-aos="fade-up" src="{{ asset('public/frontend/assets/img/thinCircle.png') }}" alt=""
            class="thinCircle">
        <img data-aos="fade-up" src="{{ asset('public/frontend/assets/img/Ellipse 1.png') }}" alt=""
            class="ellipse1">
        <img data-aos="fade-up" src="{{ asset('public/frontend/assets/img/Ellipse 6.png') }}" alt=""
            class="ellipse6">
        ...
        <div class="">
            <div class="row gy-4 d-flex justify-content-between index-title">
                ...
                <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                    <img src="{{ asset('public/frontend/assets/img/man.png') }}" class="img-fluid mb-3 mb-lg-0"
                        alt=""
                        style="" />
                </div>
            </div>
    ...
    <!-- End Hero Section -->
    <main id="main">
        <img data-aos="fade-up" src="{{ asset('public/frontend/assets/img/Ellipse 8.png') }}" alt=""
            class="ellipse8" style="top: 400%">

        <img data-aos="fade-up" src="{{ asset('public/frontend/assets/img/Ellipse 7.png') }}" alt=""
            class="ellipse7">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4 mx-auto">
                    ...
                    <div class="col-lg-3 col-md-4 mx-lg-5" data-aos="fade-up" data-aos-delay="200">
                        <div class="card">
                            <div class="card-img">
                                <img src="{{ asset('public/frontend/assets/img/news2.png') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <h3>
                    ...
                    <div class="col-lg-3 col-md-4 mx-lg-5" data-aos="fade-up" data-aos-delay="300">
                        <div class="card">
                            <div class="card-img">
                                <img src="{{ asset('public/frontend/assets/img/news3.png') }}" alt=""
                                    class="img-fluid" />
                            </div>
                            <h3>
